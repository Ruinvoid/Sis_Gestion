 ...
 * @author SalaA-02
 */
public class Agregar_Ben extends javax.swing.JFrame {

    /**
     * Creates new form Agregar_Ben
     */
    public Agregar_Ben() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Agregar_Ben.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Agregar_Ben().setVisible(true);
            }
        });
    }
